...
(function($)
{
	...
	$.Redactor.opts = {
			...
			imageUpload: '/admin/media/action?viaredactor=true', // url
			...
			air: false,
			airButtons: ['html', '|', 'formatting', '|', 'bold', 'italic', 'deleted', 'underline', '|', 'unorderedlist', 'orderedlist', 'outdent', 'indent', '|', 'image', 'video', 'table', 'link', '|', 'fontcolor', 'backcolor', '|', 'alignment', '|', 'horizontalrule'],
			...
			buttonsCustom: {},
			buttonsAdd: [],
			buttons: ['html', '|', 'formatting', '|', 'bold', 'italic', 'deleted', 'underline', '|', 'unorderedlist', 'orderedlist', 'outdent', 'indent', '|', 'image', 'video', 'file', 'table', 'link', '|', 'fontcolor', 'backcolor', '|', 'alignment', '|', 'horizontalrule'], // 'underline', 'alignleft', 'aligncenter', 'alignright', 'justify'
			...
			langs: {
				...
				ru: {
					...
					left: 'Влево',
					right: 'Вправо',
					image_web_link: 'URL картинки',
					text: 'Текст',
					mailto: 'Email',
					web: 'URL',
					video_html_code: 'Вставить код видео',
					file: 'Вставить файл',
					upload: 'Загрузить',
					download: 'Скачать',
					choose: 'Выбрать',
					or_choose: 'Выбрать другое',
					...
					align_justify: 'Выровнять текст по полю',
	...
	Redactor.fn = $.Redactor.prototype = {
		...
		initToolbar: function(lang)
		{
			return {
                ...
                outdent: {
                    ...
                    itag: 'icon-indent-left'
                },
                indent: {
                    title: '> ' + lang.indent,
                    func: 'indentingIndent',
                    itag: 'icon-indent-right'
                },
                image: {
                    title: lang.image,
                    func: 'imageShow',
		...
		buttonBuild: function(btnName, btnObject)
		{
			...
			if(typeof btnObject.itag !== 'undefined'){
               var $button = $('<a href="javascript:;" title="' + btnObject.title + '" class="redactor_btn redactor_btn_' + btnName + '"><i class="' + btnObject.itag + '"></i></a>');
            }else{
                var $button = $('<a href="javascript:;" title="' + btnObject.title + '" class="redactor_btn redactor_btn_' + btnName + '">' + btnObject.content + '</a>');
            }    
		...
		modalTemplatesInit: function()
		{
			$.extend( this.opts,
			{
				...
				+ '<footer class="btn-group">'
					+ '<button type="button" name="save" class="redactor_modal_btn btn" id="redactorSaveBtn" title="' + this.opts.curLang.save + '" ><i class="icon-save green"></i></button>'
                    + '<a href="javascript:void(null);" id="redactor_image_delete_btn" class="redactor_modal_btn btn" title="' + this.opts.curLang._delete + '"><i class="icon-trash red"></i></a>'
                    + '<a href="#" class="redactor_modal_btn redactor_btn_modal_close btn" title="' + this.opts.curLang.cancel + '"><i class="icon-remove-circle"></i></a>'
				+ '</footer>',

				modal_image: String()
				+ '<section>'
					+ '<div id="redactor_tabs">'
						+ '<a href="#" class="redactor_tabs_act">' + this.opts.curLang.link + '</a>'
					...
					+ '<div id="redactor-progress" class="redactor-progress redactor-progress-striped" style="display: none;">'
							+ '<div id="redactor-progress-bar" class="redactor-progress-bar" style="width: 100%;"></div>'
					+ '</div>'
					+ '<form id="redactorInsertImageForm" method="post" action="/admin/media?viaredactor=true" enctype="multipart/form-data">'
						+ '<div id="redactor_tab3" class="redactor_tab" style="display: none;">'
							+ '<input type="file" id="redactor_file" name="pic" />'
						+ '</div>'
					...
					+ '<div id="redactor_tab1" class="redactor_tab">'
						...
						+ '<input style="width:70%" type="text" name="redactor_file_link" id="redactor_file_link" class="redactor_input"  />'
						+ '<button class="btn btn-inverse" id="go_to_image_select" style="margin-bottom:10px"  onclick="showerp(\'{&quot;page&quot;: &quot;admin.media.select&quot;}\', \'/admin/media/home/select\', \'super_logo\', \'gallery.redactor_js\', false, true); $(\'#gallery.redactor_js\').toggle();" title="'+ this.opts.curLang.gallery +'"><i class="icon-picture"></i></button>'
					+ '</div>'
					
					+ '<div id="gallery" style="max-height:250px;display: none;" class="redactor_js scroll scroll-y">'
					+ '</div>'
					
				+ '</section>'
				+ '<footer class="btn-group">'
					+ '<button type="button" name="upload" class="redactor_modal_btn btn" id="redactor_upload_btn" title="' + this.opts.curLang.insert + '" ><i class="icon-save green"></i></button>'
					+ '<a href="#" class="redactor_modal_btn redactor_btn_modal_close btn" title="' + this.opts.curLang.cancel + '"><i class="icon-remove-circle"></i></a>'
				+ '</footer>',
				...
				+ '</section>'
				+ '<footer class="btn-group">'
					+ '<button type="button" class="redactor_modal_btn btn" id="redactor_insert_link_btn" title="' + this.opts.curLang.insert + '"><i class="icon-save green"></i></button>'
					+ '<a href="#" class="redactor_modal_btn redactor_btn_modal_close btn" title="' + this.opts.curLang.cancel + '"><i class="icon-remove-circle"></i></a>'
				+ '</footer>',
				...
				+ '</section>'
				+ '<footer class="btn-group">'
					+ '<button type="button" name="upload" class="redactor_modal_btn btn" id="redactor_insert_table_btn" title="' + this.opts.curLang.insert + '"><i class="icon-save green"></i></button>'
					+ '<a href="#" class="redactor_modal_btn redactor_btn_modal_close btn" title="' + this.opts.curLang.cancel + '"><i class="icon-remove-circle"></i></a>'
				+ '</footer>',
				...
				+ '</section>'
				+ '<footer class="btn-group">'
					+ '<button type="button" class="redactor_modal_btn btn" id="redactor_insert_video_btn" title="' + this.opts.curLang.insert + '"><i class="icon-save green"></i></button>'
					+ '<a href="javascript:void(null);" class="redactor_modal_btn redactor_btn_modal_close btn" title="' + this.opts.curLang.cancel + '"><i class="icon-remove-circle"></i></a>'
				+ '</footer>'
