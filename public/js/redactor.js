		...
		this.opts = $.extend({
			...
			modal_image_edit: String() +
				...
				'<div id="redactor_modal_footer">' +
					'<a href="javascript:void(null);" id="redactor_image_delete_btn" class="btn redactor_modal_btn">' + RLANG._delete + '</a> ' +
					'<a href="javascript:void(null);" class="btn redactor_modal_btn redactor_btn_modal_close">' + RLANG.cancel + '</a> ' +
					'<input type="button" name="save" class="btn redactor_modal_btn" id="redactorSaveBtn" value="' + RLANG.save + '" />' +
				'</div>',
			...
			modal_link: String() +
				...
				'<div id="redactor_modal_footer">' +
					'<a href="javascript:void(null);" class="btn redactor_modal_btn redactor_btn_modal_close">' + RLANG.cancel + '</a> ' +
					'<input type="button" class="btn redactor_modal_btn" id="redactor_insert_link_btn" value="' + RLANG.insert + '" />' +
				'</div>',
			...
			modal_table: String() +
				...
				'<div id="redactor_modal_footer">' +
					'<a href="javascript:void(null);" class="btn redactor_modal_btn redactor_btn_modal_close">' + RLANG.cancel + '</a> ' +
					'<input type="button" name="upload" class="btn redactor_modal_btn" id="redactor_insert_table_btn" value="' + RLANG.insert + '" />' +
				'</div>',
			...
			modal_video: String() +
				...
				'<div id="redactor_modal_footer">' +
					'<a href="javascript:void(null);" class="btn redactor_modal_btn redactor_btn_modal_close">' + RLANG.cancel + '</a>' +
					'<input type="button" class="btn redactor_modal_btn" id="redactor_insert_video_btn" value="' + RLANG.insert + '" />' +
				'</div>',
