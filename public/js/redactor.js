...
(function($){
    ...
    var Redactor = function(element, options)
    {
        ...
        this.opts = $.extend({
            ...
            imageUpload: '../../../admin/imgupload?viaredactor=true', // url
            ...
            buttons: ['html', '|', 'formatting', '|', 'bold', 'italic', 'deleted', '|', 'unorderedlist', 'orderedlist', 'outdent', 'indent', '|',
                    ...
                    'fontcolor', 'backcolor', '|', 'alignment', '|', 'horizontalrule', '|', 'save', 'status'], // 'underline', 'alignleft', 'aligncenter', 'alignright', 'justify'

            airButtons: ['formatting', '|', 'bold', 'italic', 'deleted', '|', 'unorderedlist', 'orderedlist', 'outdent', 'indent', '|', 'fontcolor', 'backcolor', 'save', 'status'],
            ...
            modal_image_edit: String() +
                ...
                '</select>' +
                '</div>' +
                '<div id="redactor_modal_footer" class="btn-group">' +
                    '<a href="javascript:void(null);" id="redactor_image_delete_btn" class="redactor_modal_btn btn btn-danger">' + RLANG._delete + '</a>&nbsp;&nbsp;&nbsp;' +
                    '<a href="javascript:void(null);" class="redactor_modal_btn redactor_btn_modal_close btn btn-inverse">' + RLANG.cancel + '</a>' +
                    '<input type="button" name="save" class="redactor_modal_btn btn" id="redactorSaveBtn" value="' + RLANG.save + '" />' +
                '</div>',
            ...
            modal_image: String() +
                ...
                '<div id="redactor_tabs">' +
                    ...
                    '<a href="javascript:void(null);" class="redactor_tabs_act">' + RLANG.choose + '</a>' +
                    '<a href="javascript:void(null);">' + RLANG.upload + '</a>' +
                '</div>' +
                '<div id="redactor_tab1" class="redactor_tab" style="display: block;">' +
                    '<label>' + RLANG.image_web_link + '</label>' +
                    '<input type="text" name="redactor_file_link" id="redactor_file_link" class="redactor_input"  />' +
                    '<div id="gallery">' +
                    '</div>' +
                    '<button class="btn" onclick="shower(\'/admin/imgupload/select\', \'super_logo\', \'gallery\', false, true); $(this).hide();">Gallery</button>' +
                '</div>' +
                '<form id="redactorInsertImageForm" method="post" action="../../../admin/imgupload?viaredactor=true" enctype="multipart/form-data">' +
                ...
                '<div id="redactor_modal_footer" class="btn-group">' +
                    '<a href="javascript:void(null);" class="redactor_modal_btn redactor_btn_modal_close btn btn-inverse">' + RLANG.cancel + '</a>' +
                    '<input type="button" name="upload" class="redactor_modal_btn btn" id="redactor_upload_btn" value="' + RLANG.insert + '" />' +
                '</div>',
            ...
            modal_link: String() +
                ...
                '<div id="redactor_modal_footer" class="btn-group">' +
                    '<a href="javascript:void(null);" class="redactor_modal_btn redactor_btn_modal_close btn btn-inverse">' + RLANG.cancel + '</a>' +
                    '<input type="button" class="redactor_modal_btn btn" id="redactor_insert_link_btn" value="' + RLANG.insert + '" />' +
                '</div>',
            ...
            modal_table: String() +
                ...
                '<div id="redactor_modal_footer">' +
                    ...
                    '<input type="button" name="upload" class="redactor_modal_btn btn" id="redactor_insert_table_btn" value="' + RLANG.insert + '" />' +
                '</div>',
            ...
            modal_video: String() +
                ...
                '<div id="redactor_modal_footer">' +
                    '<a href="javascript:void(null);" class="redactor_modal_btn redactor_btn_modal_close">' + RLANG.cancel + '</a>' +
                    '<input type="button" class="redactor_modal_btn btn" id="redactor_insert_video_btn" value="' + RLANG.insert + '" />' +
                '</div>',
    ...
    Redactor.prototype = {
        ...
        buildButton: function(key, s)
        {
            if(key == 'save')
            {
                var button = $('<button type="button" style="text-decoration: none" class="btn btn-link" onclick="save_btn();" title="' + s.title + '" class="redactor_btn_' + key + '"><i class="icon-save" style="color: ' + s.color + '"></i></a>');
            }
            else if(key == 'status'){
                var button = $('<a id="status" class="status"></a>');
            }
            else if(typeof s.itag !== 'undefined')
            {
                var button = $('<a href="javascript:void(null);" title="' + s.title + '" class="redactor_btn_' + key + '"><i class="' + s.itag + '" style="color: ' + s.color + '"></i></a>');
            }
            else if(typeof s.content !== 'undefined')
            {
            ...
            $.each(obj, $.proxy(
                function (x, d)
                {
                    ...
                    else
                    {
                        if(d.tag != 'undefined')
                        {
                            drop_a = $('<' + d.tag + '><a href="javascript:void(null);" class="' + d.className + '">' + d.title + '</a></' + d.tag + '>');
                        }
                        else
                        {
        ...
        modalInit: function(title, content, width, callback)
        {
            ...
            if (this.isMobile() === false)
            {
                ...
                {
                    var height = $('#redactor_modal').outerHeight();
                    $('#redactor_modal').css({ top: '40%', height: 'auto', minHeight: 'auto', marginTop: '-' + (height+10)/2 + 'px' });
