...
<h3>
	<i class="icon-user"></i> {{ __('content.users_word') }} · {{ $user->name }}
</h3>
...
@section('users')
	<div class="offset3 span6">
		@foreach($fields as $column => $value)
			...
			{{ Utilites::html_form_build($fields[$column]['type'], $fields[$column]['data'], View::make('admin.assets.form_pattern'), __('forms.'.$column.'_word'), $fields[$column]['attributes'], $user->id) }}
				...
				<div class="control-group" style="text-align:center">
					<div class="controls">
						...
						<button 
							...
							class="btn" 
							type="button"
							data-link="{{ URL::to('admin/users/action/save') }}" 
