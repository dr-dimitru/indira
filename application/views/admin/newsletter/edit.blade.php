...
<h3>
	<i class="icon-envelope-alt"></i> {{ __('content.newsletter') }} · {{ $letter->title }}
</h3>
...
<div class="module-actions">
	<div class="btn-group pull-left">
		...
		<button 
			...
			data-link="{{ action('admin.newsletter.action@save') }}"
			data-out="null"
			data-out-popup="true"
		...
		<div class="span11">
			...
			<div class="form-horizontal">
				...
				@foreach($fields as $column => $value)
					...
					{{ Utilites::html_form_build($fields[$column]['type'], $fields[$column]['data'], View::make('admin.assets.form_pattern_2'), __('newsletter.'.$column), $fields[$column]['attributes'], $letter->id) }}
				...
				<div class="control-group" style="text-align: center">
					<div class="controls">
						...
						<button 
							...
							type="button"
							disabled="disabled" 
							data-link="{{ action('admin.newsletter.action@save') }}?send=true" 
							data-post="{{ e($json_save) }}"
							data-out="null"
							data-out-popup="true"
							data-prevent-follow="true"
