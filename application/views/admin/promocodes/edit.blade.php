...
<div class="modal-body scroll scroll-y">
	...
	@foreach($fields as $column => $value)
		...
		{{ Utilites::html_form_build($fields[$column]['type'], $fields[$column]['data'], View::make('admin.assets.form_pattern'), __('promocode.'.$column), $fields[$column]['attributes'], $promocode->id) }}
...
<div class="modal-footer">
	<div class="actions">
		...
		<button 
			id="ajax_save_button_{{ $promocode->id }}"
			class="btn"
			type="button"
			disabled="disabled" 
			data-link="{{ action('admin.promocodes.action@save') }}" 
