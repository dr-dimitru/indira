...
<h3>
	<i class="icon-group"></i> {{ $admin->name }}
</h3>
...
@section('admins')
	<div class="offset3 span6">
		@foreach($fields as $column => $value)
			...
			{{ Utilites::html_form_build($fields[$column]['type'], $fields[$column]['data'], View::make('admin.assets.form_pattern'), __('forms.'.$column.'_word'), $fields[$column]['attributes'], $admin->id) }}
				...
				<div class="control-group" style="text-align:center">
					<div class="controls">
						...
						<button 
							...
							class="btn" 
							type="button"
							data-link="{{ URL::to('admin/admins/action/save') }}" 
