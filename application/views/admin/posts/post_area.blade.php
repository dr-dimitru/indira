...
<? $json_save = '{"id": "'.$post->id.'", "title": "\'+encodeURI($(\'#title_'.$post->id.'\').val())+\'", "text": "\'+encodeURI($(\'#text_'.$post->id.'\').html())+\'", "access": "\'+$(\'#post_access_'.$post->id.'\').val()+\'", "media": "\'+$(\'#selected_media_'.$post->id.'\').val()+\'", "section": "\'+$(\'#section_'.$post->id.'\').val()+\'", "tags": "\'+encodeURI($(\'#tags_'.$post->id.'\').val())+\'", "lang": "\'+$(\'#lang_'.$post->id.'\').val()+\'"}'; ?>
			...
			<button 
				...
				type="button"
				disabled="disabled" 
				onclick="showerp('<?= htmlspecialchars($json_save) ?>', '{{ URL::to('admin/post_area/save') }}', 'save_button_{{ $post->id }}', 'status_{{ $post->id }}', false, true); ">
...
<script>
	function save_btn(){
		showerp('<?= $json_save ?>', '{{ URL::to("admin/post_area/save") }}', 'save_button_{{ $post->id }}', 'status_{{ $post->id }}', false, true);
	}
</script>