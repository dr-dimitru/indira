	...
	public function action_index($item=null)
	{
		...
		if($item){
		    ...
		    if($post){
			    ...
			    {
			        return View::make('item.no_access')->with('id', null)->with('title', Lang::line('content.permissions_denied')->get(Session::get('lang')))->with('post', $post);
			    ...
			    elseif ($post) 
				{
			       ...
			       return View::make('item.index')->with('post', $post);
			    }
			    else {
			        ...
			        return View::make('item.no_item')->with('post', $post)->with('title', Lang::line('content.no_page')->get(Session::get('lang')));
			    }
